    ...
    const features = [
        {
            ...
            icon:<PiContactlessPayment className='text-4xl  text-[#5CAF90] mx-auto'></PiContactlessPayment>
        },
        {
            id: 2,
            title: "24x7 Support",
            subtitle: "Contact us 24 hours a day, 7 days a week",
            icon: < AiFillBank className='text-4xl  text-[#5CAF90] mx-auto'></AiFillBank>
        },
        {
            id: 3,
            title: "30 Days Return",
            subtitle: "Simply return it within 30 days for an exchange",
            icon: < IoCartOutline className='text-4xl  text-[#5CAF90] mx-auto'></IoCartOutline>
        },
        {
            id: 4,
            title: "Payment Secure",
            subtitle: "Secure payment processing available 24/7",
            icon: <BiSupport className='text-4xl  text-[#5CAF90] mx-auto'></BiSupport>
        }
    ];
