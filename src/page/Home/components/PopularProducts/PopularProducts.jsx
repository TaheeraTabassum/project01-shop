...
const PopularProducts = () => {
    ...
    return (
        <div className='container md:mx-auto px-4 sm:px-8 md:px-12 lg:px-24 pt-24 '>
            ...
            <div>
                <div className='grid grid-cols-1 pl-18 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8  mb-4 mt-12'>
                    {filterProduct
